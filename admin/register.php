        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellpadding="0">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <form class="" action="register_edit.php" method="POST">
                  <input type="hidden" name="edit_id" value="<?php echo $row['id'];?>">
                  <button type="submit" name="edit_btn" class="btn btn-success"><i>EDIT</i></button></form>
              ...
              <td>
                <form action="code.php" method="post">
                  ...
                  <button name="delete_btn" type="submit" class="btn btn-danger"><i>DELETE</i></button>
                </form>
              </td>
            </tr>
             <?php
